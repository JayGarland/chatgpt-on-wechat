...
available_setting = {
    ...
    "sydney_credit": "\n-----------开发者留言------------\n\n---------该消息仅出现一次----------\n如果你觉得Sydney还不错，Sydney同时还支持私人定制，让她变成你设定的个人角色，欢迎添加我微信咨询更多:\nnope_nope_nope_nope\n(直接搜索该昵称即可)\n\n#MITLicense\n#RajayouxAllRightsReserved!",
    "sydney_debug" : False, #belongs to old sydney core
    "customerSet": [{"session_id": "promptsetting", "botstatement": "bottail"}], #config usage
    "nosearch": True, #belongs to sydney core
    "enablesuggest": False, #belongs to old sydney core
    "voicespecies": "",
    "stream": False,
    "pre_reply": "",
    "Minimax_api_key": "",
